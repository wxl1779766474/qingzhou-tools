...
const METRIC_RANGES = Object.freeze({
  ...
  memoryCodeKb: [0, Number.MAX_SAFE_INTEGER],
  memoryGraphicsKb: [0, Number.MAX_SAFE_INTEGER],
...
const METRIC_ALIASES = Object.freeze({
  ...
  memoryCodeKb: ["memoryCodeKb", "codeKb"],
  memoryGraphicsKb: ["memoryGraphicsKb", "graphicsKb"],
...
function metricSpecificValue(source, field) {
  ...
  const matches = {
    ...
    memoryCodeKb: new Set(["memory", "meminfo", "code", "memorycode"]),
    memoryGraphicsKb: new Set(["memory", "meminfo", "graphics", "memorygraphics"]),
...
function collectorMetricValue(source, field) {
  ...
  const paths = {
    ...
    memoryCodeKb: [["memory", "memoryCodeKb"], ["memory", "codeKb"], ["memInfo", "codeKb"]],
    memoryGraphicsKb: [["memory", "memoryGraphicsKb"], ["memory", "graphicsKb"], ["memInfo", "graphicsKb"]],
